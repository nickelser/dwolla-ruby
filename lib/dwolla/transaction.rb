module Dwolla
  class Transaction
    ...
    attr_accessor :origin, :destination, :destination_type, :type, :amount, :pin, :id, :source, :source_type, :description, :funds_source, :facilitator_amount
    ...
    private
      ...
      def to_payload
        ...
        payload[:facilitatorAmount] = facilitator_amount if facilitator_amount
